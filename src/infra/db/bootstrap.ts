import type { Database as SqlJsDatabaseInstance } from "sql.js";

import { defaultPlans } from "../../domain/plans/default-plans";

export function bootstrapDatabase(sqlite: SqlJsDatabaseInstance): void {
  sqlite.exec(`
